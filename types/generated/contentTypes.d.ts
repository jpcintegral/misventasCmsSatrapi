...
export interface ApiArticuloArticulo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imagen: Schema.Attribute.Media<'videos' | 'audios' | 'files', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    mililitros: Schema.Attribute.Integer;
    precio_proveedor: Schema.Attribute.Decimal;
    ...
    >;
    seller_order_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::seller-order-item.seller-order-item'
    >;
...
export interface ApiPaymentPayment extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    evidencia: Schema.Attribute.Media<'videos' | 'audios' | 'files', true>;
    ...
    >;
    seller_order: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiPurchaseOrderPurchaseOrder
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    status: Schema.Attribute.Enumeration<['PENDIENTE', 'PARCIAL', 'PAGADO']> &
...
export interface ApiSellerOrderItemSellerOrderItem
  extends Struct.CollectionTypeSchema {
  collectionName: 'seller_order_items';
  info: {
    displayName: 'seller-order-item';
    pluralName: 'seller-order-items';
    singularName: 'seller-order-item';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    precio_al_vendedor: Schema.Attribute.Decimal;
    precio_venta: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    seller_order: Schema.Attribute.Relation<
      'manyToOne',
...
export interface ApiSellerOrderSellerOrder extends Struct.CollectionTypeSchema {
  collectionName: 'seller_orders';
  info: {
    displayName: 'seller-order';
    pluralName: 'seller-orders';
    singularName: 'seller-order';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiVendedorVendedor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    precio_porcentaje: Schema.Attribute.Decimal;
    publishedAt: Schema.Attribute.DateTime;
    seller_orders: Schema.Attribute.Relation<
      'oneToMany',
      'api::seller-order.seller-order'
    >;
    telefono: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::seller-order-item.seller-order-item': ApiSellerOrderItemSellerOrderItem;
      'api::seller-order.seller-order': ApiSellerOrderSellerOrder;
